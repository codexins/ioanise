(function ($) {
    $.fn.ColorPanel = function (options) {
        ...
        // Create a dummy stylesheet link to initiate style switcher
        $("head").find('#mastersheet').after("<link rel='stylesheet' id='cpswitch' href='assets/css/placehold.css'>");

        if($.cookie(addStyle) !== 'assets/css/main.css') {
